  ...
  return (
    ...
    >
      <div className="container" style={{ backgroundColor: "" }}>
        <div className="d-flex gap-5" style={{ marginLeft: "83px" }}>
          <img
        ...
        <div className="d-flex gap-3" style={{ marginRight: "45px" }}>
          <button
            type="button"
            className="btn px-3  -bs-btn-color:white fw-normal"
            id="btn1"
            style={{
              borderRadius: "30px",
              borderColor: "blue",
          ...
          >
            <a
              ...
              data-bs-toggle="dropdown"
              aria-expanded="false"
              style={{ width: "180px", height: "35px", marginTop: "5px" }}
            >
              For Employers
